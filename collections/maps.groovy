...
def aMap = [
        ...
        (keyVar): 'Another value' // If you want the key to be the value of a variable, you need to put it in parentheses
]
...
println aMap[keyVar] // Access the entry with the value of key variable
